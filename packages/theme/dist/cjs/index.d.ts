...
export declare const defaultTheme: {
    icon: import("./types").IconTheme;
    loader: import("./types").LoaderTheme;
    sideNav: import("./types").SideNavTheme;
    sidePanel: import("./types").SidePanelTheme;
    header: import("./types").HeaderTheme;
