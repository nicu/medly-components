...
export declare type ItemsPosition = 'top' | 'bottom' | 'left' | 'right' | 'center';
export declare type Variants = 'solid' | 'flat';
export declare type FlowDirection = 'vertical' | 'horizontal';
