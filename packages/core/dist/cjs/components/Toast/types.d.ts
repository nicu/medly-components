...
export declare type ToastVariants = 'success' | 'error' | 'info' | 'warning';
...
export declare type ToastComponentProps = Omit<HTMLProps<HTMLDivElement>, 'id' | 'action'> & ToastProps;
export declare type StyledToastProps = Omit<ToastProps, 'id'>;
