...
export declare enum DateRangeSelectionEnum {
    WEEK = "WEEK",
    MONTH = "MONTH",
    YEAR = "YEAR",
    CUSTOM = "CUSTOM",
...
export declare type DateRangeProps = Omit<HTMLProps<HTMLInputElement>, 'prefix' | 'size' | 'height' | 'value' | 'onChange'> & {
    /** Selected date range */
    value: DateRangeType;
    ...
    customDateRangeOptions?: Array<{
        label: string;
        value: DateRangeSelectionEnum;
    }>;
};
