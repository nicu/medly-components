...
export declare type Data = ObjectType[];
export declare type RowHoverActionsType = FC<{
    rowData?: ObjectType;
    rowId?: any;
}>;
export declare type MaxColumnSizes = {
    [k: string]: number;
};
...
export declare type CustomTableCellComponent = FC<{
    data?: any;
    rowId?: any;
    disabled?: boolean;
    rowData?: ObjectType;
}>;
export declare type RowHoverActionsComponent = FC<{
    rowData?: ObjectType;
    rowId?: any;
}>;
